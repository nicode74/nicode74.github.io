  ...
  return (
    <section id="home" className="pt-32 pb-20 md:pt-48 md:pb-32 flex flex-col items-center text-center">
      <div className="container mx-auto px-6">
        ...
        <h1 className="text-4xl md:text-7xl font-bold tracking-tighter mb-6 bg-linear-to-r from-white to-gray-500 bg-clip-text text-transparent animate-fade-in-delayed">
          Nicolas Tegar Nurhadi Putra
        </h1>
        <h3 className="text-xl md:text-2xl font-medium text-gray-400 mb-8 max-w-2xl mx-auto animate-fade-in delay-300">
          Informatics Student | <span className="text-accent">Software Developer</span>
        </h3>
        <p className="text-lg text-gray-500 mb-12 max-w-xl mx-auto italic animate-fade-in delay-400">
